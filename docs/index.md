...
See the [`examples`](https://github.com/aws-deadline/deadline-cloud-job-attachments/tree/mainline/examples) directory for some simple examples on how to use job attachments. See the [developer guide][developer-guide] for a demonstration of how the CLI works with job attachments.
...
[hash-cache]: https://github.com/aws-deadline/deadline-cloud-job-attachments/blob/mainline/src/deadline/job_attachments/caches/hash_cache.py
[s3-check-cache]: https://github.com/aws-deadline/deadline-cloud-job-attachments/blob/mainline/src/deadline/job_attachments/caches/s3_check_cache.py
